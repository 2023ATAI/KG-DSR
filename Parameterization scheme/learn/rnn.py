...
class Cell(torch.nn.Module):
    """
        ...
        output_size : int
            Number of features ie number of choices possible in the library of phytokens.
    ...
    def __init__(self,
        ...
        self.output_activation = lambda x: -torch.nn.functional.relu(x)
                                #lambda x: torch.nn.functional.relu(x) # Mapping output to log(p)
    ...
    def forward(self,
                ...
                states,  prior                                             # (n_layers, 2, batch_size, hidden_size)
               ):
        # --------- Input dense layer ---------
