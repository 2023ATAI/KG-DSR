...
# Internal imports
from reward import reward as reward_funcs
...
class RunVisualiser:
    ...
    def make_prints(self):
        ...
        print(self.run_logger.overall_best_prog_str_history[-1])
        print(self.run_logger.overall_best_prog_free_const_history[-1])
        print(self.run_logger.best_prog)
        ...
        print(self.run_logger.best_prog_epoch_str_history[-1])
        print(self.run_logger.best_prog_epoch_free_const_history[-1])
        print(self.run_logger.best_prog_epoch)
        print("\n")
        #print("-> Free constant value is : \n%s"%(self.run_logger.best_prog_epoch_free_const_history[0]))
    ...
    def visualise (self, run_logger, batch):
        ...
        if epoch%self.epoch_refresh_rate == 0:
            try:
                ...
                print("Unable to save train curves data_utils.")
        # Data Pareto
        if epoch%self.epoch_refresh_rate == 0:
            try:
                if self.do_save:
                ...
                print("Unable to save pareto data_utils.")
        # Figure Pareto
        if epoch%self.epoch_refresh_rate == 0:
            try:
                if self.do_save:
