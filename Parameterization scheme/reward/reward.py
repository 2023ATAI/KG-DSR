...
def SquashedNRMSE_GS (y_target, y_pred,):
    """
    Squashed NRMSE reward.
    Parameters
    ----------
...
def RewardsComputer(programs,
    ...
    """
    Computes rewards of programs on X data_utils accordingly with target y_target and reward reward_function using torch
    for acceleration.
    Parameters
    ----------
...
def make_RewardsComputer(reward_function     = SquashedNRMSE,
    ...
    # rewards_computer
    def rewards_computer(programs, X, y_target, X_names, free_const_opti_args):
