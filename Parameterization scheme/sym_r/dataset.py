...
class Dataset:
    ...
    """
    def __init__(self, library, X, y_target,X_names):
        """
        Parameters
        ----------
        ...
        # --- ASSERT VARIABLE ID ---
        # Check that all phytokens in the library have id < n_dim
        ...
        assert mask_wrong_id.sum() == 0, "Can not access input variable data_utils X by X[var_id] of phytokens :" \
